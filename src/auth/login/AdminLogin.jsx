  ...
  return (
    <div className="flex h-[700px] w-full">
      ...
      <div className="w-full flex flex-col items-center justify-center bg-gray-50">
        <form className="md:w-96 w-80 flex flex-col items-center justify-center bg-white p-8 rounded-lg shadow-lg">
          ...
          <div className="flex items-center gap-4 w-full my-5">
            ...
            <p className="whitespace-nowrap text-sm text-gray-500/90">
          ...
          <div className="w-full flex items-center justify-between mt-8 text-gray-500/80">
            <div className="flex items-center gap-2">
              <input className="h-5 w-5" type="checkbox" id="remember" />
